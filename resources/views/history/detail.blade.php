        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran 
                    silahkan transfer di rekening <Strong>Bank BRI Nomer Rekening : 32112-878787-211</Strong>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($pesanan_details as $pesanan_detail)
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>
                                        <img src="{{ url('uploads') }}/{{ $pesanan_detail->barang->gambar }}" width="100" class="rounded" alt="">
                                    </td>
